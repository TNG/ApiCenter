...
INSERT INTO version (id, title, version, description, content, interface_id) VALUES
(
    '243a7fb09c3e4b788fce5425e43b9cbe',
    'versionA',
    '1.0.0',
    'descriptionA',
...
INSERT INTO version (id, title, version, description, content, interface_id) VALUES
(
    '92e8ebe4c9d846b5b54ea69c025c35e5',
    'versionB',
    '2.3.0',
    NULL,
    '{\n  \"openapi\": \"3.0\",\n  \"info\": {\n    \"version\": \"2.3.0\",\n    \"title\": \"versionB\",\n}")',
...
INSERT INTO version (id, title, version, description, content, interface_id) VALUES
(
    'b344904c63fa444d9cb85d4fd804af36',
    'versionC',
    '7.0.0',
    'descriptionA',
...
INSERT INTO version (id, title, version, description, content, interface_id) VALUES
(
    'c1f1c7e30aa44e339cc028933163f399',
    'versionD',
    '2.3.4',
    NULL,
    '{\n  \"openapi\": \"3.0\",\n  \"info\": {\n    \"version\": \"2.3.4\",\n    \"title\": \"versionD\",\n}")',
